Rails.application.routes.draw do
  ...
  get 'u/:username/:space_name', to: 'short_links#show_user_space', as: 'short_user_space'
  get 'u/:username/:space_name/:tiddler_title', to: 'short_links#show_user_space_tiddler', as: 'short_user_space_tiddler'
